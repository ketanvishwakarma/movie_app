...
abstract class $TrendingMediaCopyWith<$Res> {
  ...
  @useResult
  $Res call({String title, String coverImage});
}
...
class _$_TrendingMedia implements _TrendingMedia {
  _$_TrendingMedia({required this.title, required this.coverImage});
  ...
  @override
  String toString() {
    return 'TrendingMedia(title: $title, coverImage: $coverImage)';
  }
...
abstract class _TrendingMedia implements TrendingMedia {
  factory _TrendingMedia(
      ...
      required final String coverImage}) = _$_TrendingMedia;
